# Утилита очистки кэша 1С:Предприятие (v2.0)
...
| `-Force` или `-Y`  | Принудительная очистка, даже если запущены процессы 1С(не сичтит заблокированные файлы                   | `.\clear_1C_cash.ps1 -Force`                  |
